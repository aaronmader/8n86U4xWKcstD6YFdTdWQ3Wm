...
############################
# Moved to stable version of Google Chrome after the unstable version started yielding 'page crashed' errors.
# see: https://github.com/GoogleChrome/puppeteer/issues/2725
